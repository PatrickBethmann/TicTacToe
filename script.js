...
const game = (() => {
    ...
    const checkForWinner = () => {
        ...
        for (let i = 0; i < currentBoard.length; i++) {
            ...
            if (row[0] === currentSign && row[1] === currentSign && row[2] === currentSign) {
                winner = true;
            }
        }
        ...
        for (let i = 0; i < currentBoard[0].length; i++) {
            const column = [currentBoard[0][i], currentBoard[1][i], currentBoard[2][i]];
            if (column[0] === currentSign && column[1] === currentSign && column[2] === currentSign) {
                winner = true;
            }
        }
    ...
    const checkForTie = () => {
        ...
        // Checks for 3 diagonal
        if (
            (currentBoard[0][0] !== currentSign && currentBoard[0][0] !== null) ||
            (currentBoard[1][1] !== currentSign && currentBoard[1][1] !== null) ||
        ...
        if (
            (currentBoard[0][2] !== currentSign && currentBoard[0][2] !== null) ||
            (currentBoard[1][1] !== currentSign && currentBoard[1][1] !== null) ||
